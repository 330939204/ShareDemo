...
public class EntryBean {
  ...
  /**
   * mean_type : [{"info_type":"example","info_id":"41108","example":[{"example_id":"39395","tts_size":"10.0","tran":"我们一起玩得真痛快。","ex":"We
   ...
   * so good to hear your voice after all this time.","tts_mp3":"3/a/9/3a98c2472c89154b0133ef0e6333b33a.mp3"}]}]
   * gramarinfo : []
   * tran : 愉快的；有趣的；令人愉快的
   * def : <b>Good</b> means pleasant or enjoyable.
   * mean_id : 30026
   * posp : [{"label":"ADJ-GRADED"}]
   */
